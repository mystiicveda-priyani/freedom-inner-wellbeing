      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-emerald/70 text-lg mb-8 leading-relaxed">
            ...
            <div className="grid grid-cols-2 gap-4">
              {features.map((feature, index) => (
                ...
                >
                  ...
                  <div>
                    <h4 className="font-medium text-emerald text-sm mb-1">
                      {feature.title}
                    </h4>
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.98 }}
              className="inline-flex items-center gap-2 mt-10 px-8 py-4 bg-emerald text-ivory rounded-full font-medium hover:bg-emerald-light transition-colors duration-300"
            >
              Join the Community
            </motion.a>
          </motion.div>
          ...
          >
            <div className="relative bg-card rounded-3xl p-8 border border-border/30 shadow-lg">
              ...
              {/* Floating Stats */}
              <div className="absolute -bottom-4 -right-4 bg-emerald text-ivory rounded-2xl px-6 py-4 shadow-lg">
